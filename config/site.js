module.exports = {
  pathPrefix: process.env.NODE_ENV === 'production' ? '/niQC' : '/', // Prefix for all links. If you deploy your site to example.com/portfolio your pathPrefix should be "portfolio"
  title: 'niQC', // Navigation and Site Title
  titleAlt: 'NeuroImaging Quality Control (niQC)', // Title for JSONLD
